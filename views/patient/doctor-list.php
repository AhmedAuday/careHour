        ...
        <div id="sidebar-scrollbar">
          <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
              ...
              <li>
                <a href="document.html" class="iq-waves-effect"
                  ><i class="ri-group-fill"></i><span>document</span></a
                >
              </li>
              ...
              <li class="active main-active">
                ...
                >
                  ...
                  <li>
                    <a href="my-docotor-list.html"
                      ><i class="ri-profile-fill"></i>MY Doctors</a
                    >
                  </li>
                </ul>
              </li>
