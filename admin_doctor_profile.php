                                            ...
                                            <ul class="list-inline m-0 p-0">
                                                <li>
                                                    ...
                                                    <div class="d-inline-block w-100">
                                                        <p class="badge badge-primary">09:00
                                                            AM</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <h6 class="float-left mb-1">Anna
                                                        Mull (Fever)</h6>
                                                    <small class="float-right mt-1">Today</small>
                                                    <div class="d-inline-block w-100">
                                                        <p class="badge badge-danger">09:15
                                                            AM</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <h6 class="float-left mb-1">Petey
                                                        Cruiser (X-ray)</h6>
                                                    <small class="float-right mt-1">Today</small>
                                                    <div class="d-inline-block w-100">
                                                        <p class="badge badge-warning">10:00
                                                            AM</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <h6 class="float-left mb-1">
                                                        Anna Sthesia (Full body
                                                        Check up)
                                                    </h6>
                                                    <small class="float-right mt-1">Today</small>
                                                    <div class="d-inline-block w-100">
                                                        <p class="badge badge-info">01:00
                                                            PM</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="d-inline-block w-100">
                                                        <p class="badge badge-success">09:00
                                                            AM</p>
                                                    </div>
                                                </li>
                                            </ul>
