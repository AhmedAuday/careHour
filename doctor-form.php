                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="iq-card">
                                ...
                                <!-- here i merged the doctor information and the working office houre if you dont like it you can remove the merge by cutting the office hours and pastting it after the div under it  -->
                                <div class="iq-card-body">
                                    <div class="about-info m-0 p-0">
                                        <div class="row">
                                            <!-- get the name of the doctor check?-->
                                            <div class="col-4">First Name:</div>
                                            <div class="col-8"><?= $doctor->getFirst_name()?></div>
                                            <div class="col-4">Last Name:</div>
                                            <div class="col-8"><?= $doctor->getLast_name()?></div>
