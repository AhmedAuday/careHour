...
var oldEvent,
    ...
    myData = [{
        ...
        id: 2,
        start: '2023-05-21T15:00',
        end: '2023-05-21T16:00',
        ...
        id: 3,
        start: '2023-05-20T18:00',
        end: '2023-05-20T22:00',
        title: 'Dexter BD',
        description: '',
        allDay: false,
        free: true,
        ...
        id: 4,
        start: '2023-05-22T10:30',
        end: '2023-05-22T11:30',
...
function createAddPopup(elm) {
    ...
    popup.setOptions({
        headerText: 'New event', // More info about headerText: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#opt-headerText
        buttons: ['cancel',
            { // More info about buttons: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#opt-buttons
                text: 'Add',
                keyCode: 'enter',
                handler: function() {
...
var calendar = mobiscroll.eventcalendar('#demo-add-delete-event', {
    ...
    onEventClick: function(
        args
    ) { // More info about onEventClick: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#event-onEventClick
    ...
    onEventCreated: function(
        args
    ) { // More info about onEventCreated: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#event-onEventCreated
        popup.close();
        // store temporary event
        tempEvent = args.event;
        createAddPopup(args.target);
    },
    onEventDeleted: function() { // More info about onEventDeleted: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#event-onEventDeleted
        mobiscroll.snackbar({
            button: {
                action: function() {
    ...
    responsive: { // More info about responsive: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#opt-responsive
        medium: {
            ...
            anchor: document.getElementById(
                'event-color-cont'
            ), // More info about anchor: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#opt-anchor
            buttons: {} // More info about buttons: https://docs.mobiscroll.com/5-24-1/javascript/eventcalendar#opt-buttons
        }
    }
});
