<?php
  ...
  class Patient_files extends Database {
    ...
    public function add(){
      $sql = "INSERT INTO `patient_files` (`id`, `patient_id`, `doctor_id`, `file_name`, `file_type`, `created_at`, `timee`, `time`) VALUES 
      ('$this->id', '$this->patient_id', '$this->doctor_id', '$this->file_name', '$this->file_type', '$this->created_at', '$this->timee', '$this->time')";
      if($this->db()->query($sql)){
        return true;
      }else{
        return false;
