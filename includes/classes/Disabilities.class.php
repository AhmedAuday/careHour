<?php
  ...
  class Disabilities extends Database {
    ...
    public function add(){
      $sql = "INSERT INTO `disabilities` (`id`, `patient_id`, `disability_name`, `onset_date`, `notes`, `timee`, `time`) VALUES 
      ('$this->id', '$this->patient_id', '$this->disability_name', '$this->onset_date', '$this->notes', '$this->timee', '$this->time')";
      if($this->db()->query($sql)){
        return true;
      }else{
        return false;
