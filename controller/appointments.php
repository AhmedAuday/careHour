<?php
  ...
  if(!empty($_GET['on_date'])){$appointments->setOn_date($_GET['on_date']);}
  ...
  if(!empty($_GET['getByOn_date'])){$appointments->setOn_date($_GET['getByOn_date']); if($appointments->getByOn_date()){exit("this.id='{$appointments->getId()}', this.doctor_id='{$appointments->getDoctor_id()}', this.patient_id='{$appointments->getPatient_id()}', this.appointment_date='{$appointments->getAppointment_date()}', this.appointment_type='{$appointments->getAppointment_type()}', this.notes='{$appointments->getNotes()}', this.timee='{$appointments->getTimee()}', this.on_date='{$appointments->getOn_date()}', this.time='{$appointments->getTime()}'");}}
