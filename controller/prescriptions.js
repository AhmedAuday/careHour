class Prescriptions{
  ...
  async add(){ try{ eval(await this.request('controller/prescriptions.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&prescription_date=' + this.prescription_date + '&dosage=' + this.dosage + '&timee=' + this.timee + '&time=' + this.time + '&add=1')); }catch(err){}}
  async update(){ try{ eval(await this.request('controller/prescriptions.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&prescription_date=' + this.prescription_date + '&dosage=' + this.dosage + '&timee=' + this.timee + '&time=' + this.time + '&update=1')); }catch(err){}}
  ...
  async getByTimee(){ try{ eval(await this.request('controller/prescriptions.php?getByTimee=' + this.timee)); }catch(err){}}
  async getByTime(){ try{ eval(await this.request('controller/prescriptions.php?getByTime=' + this.time)); }catch(err){}}
  // GET THE RESULT AS JSON
  async getBySet(value = 100000){ try{ return await this.request('controller/prescriptions.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&prescription_date=' + this.prescription_date + '&dosage=' + this.dosage + '&timee=' + this.timee + '&time=' + this.time + '&getBySet=' + value); }catch(err){}}
