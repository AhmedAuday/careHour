<?php
  ...
  if(!empty($_GET['timee'])){$vitals->setTimee($_GET['timee']);}
  ...
  if(!empty($_GET['getByTimee'])){$vitals->setTimee($_GET['getByTimee']); if($vitals->getByTimee()){exit("this.id='{$vitals->getId()}', this.patient_id='{$vitals->getPatient_id()}', this.date_time='{$vitals->getDate_time()}', this.temperature='{$vitals->getTemperature()}', this.blood_pressure='{$vitals->getBlood_pressure()}', this.heart_rate='{$vitals->getHeart_rate()}', this.respiratory_rate='{$vitals->getRespiratory_rate()}', this.timee='{$vitals->getTimee()}', this.time='{$vitals->getTime()}'");}}
