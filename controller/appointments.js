class Appointments{
  ...
  async add(){ try{ eval(await this.request('controller/appointments.php?id=' + this.id + '&doctor_id=' + this.doctor_id + '&patient_id=' + this.patient_id + '&appointment_date=' + this.appointment_date + '&appointment_type=' + this.appointment_type + '&notes=' + this.notes + '&timee=' + this.timee + '&time=' + this.time + '&add=1')); }catch(err){}}
  async update(){ try{ eval(await this.request('controller/appointments.php?id=' + this.id + '&doctor_id=' + this.doctor_id + '&patient_id=' + this.patient_id + '&appointment_date=' + this.appointment_date + '&appointment_type=' + this.appointment_type + '&notes=' + this.notes + '&timee=' + this.timee + '&time=' + this.time + '&update=1')); }catch(err){}}
  ...
  async getBySet(value = 100000){ try{ return await this.request('controller/appointments.php?id=' + this.id + '&doctor_id=' + this.doctor_id + '&patient_id=' + this.patient_id + '&appointment_date=' + this.appointment_date + '&appointment_type=' + this.appointment_type + '&notes=' + this.notes + '&timee=' + this.timee + '&time=' + this.time + '&getBySet=' + value); }catch(err){}}
