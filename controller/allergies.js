class Allergies{
  ...
  async add(){ try{ eval(await this.request('controller/allergies.php?id=' + this.id + '&patient_id=' + this.patient_id + '&name=' + this.name + '&severity=' + this.severity + '&spicifie_allerge=' + this.spicifie_allerge + '&timee=' + this.timee + '&time=' + this.time + '&add=1')); }catch(err){}}
  async update(){ try{ eval(await this.request('controller/allergies.php?id=' + this.id + '&patient_id=' + this.patient_id + '&name=' + this.name + '&severity=' + this.severity + '&spicifie_allerge=' + this.spicifie_allerge + '&timee=' + this.timee + '&time=' + this.time + '&update=1')); }catch(err){}}
  ...
  async getBySet(value = 100000){ try{ return await this.request('controller/allergies.php?id=' + this.id + '&patient_id=' + this.patient_id + '&name=' + this.name + '&severity=' + this.severity + '&spicifie_allerge=' + this.spicifie_allerge + '&timee=' + this.timee + '&time=' + this.time + '&getBySet=' + value); }catch(err){}}
