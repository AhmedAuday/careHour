class Disabilities{
  ...
  async add(){ try{ eval(await this.request('controller/disabilities.php?id=' + this.id + '&patient_id=' + this.patient_id + '&disability_name=' + this.disability_name + '&onset_date=' + this.onset_date + '&notes=' + this.notes + '&time=' + this.time + '&add=1')); }catch(err){}}
  async update(){ try{ eval(await this.request('controller/disabilities.php?id=' + this.id + '&patient_id=' + this.patient_id + '&disability_name=' + this.disability_name + '&onset_date=' + this.onset_date + '&notes=' + this.notes + '&time=' + this.time + '&update=1')); }catch(err){}}
  ...
  async getBySet(value = 100000){ try{ return await this.request('controller/disabilities.php?id=' + this.id + '&patient_id=' + this.patient_id + '&disability_name=' + this.disability_name + '&onset_date=' + this.onset_date + '&notes=' + this.notes + '&time=' + this.time + '&getBySet=' + value); }catch(err){}}
