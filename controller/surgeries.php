<?php
  ...
  if(!empty($_GET['timee'])){$surgeries->setTimee($_GET['timee']);}
  ...
  if(!empty($_GET['getByTimee'])){$surgeries->setTimee($_GET['getByTimee']); if($surgeries->getByTimee()){exit("this.id='{$surgeries->getId()}', this.doctor_id='{$surgeries->getDoctor_id()}', this.patient_id='{$surgeries->getPatient_id()}', this.surgery_name='{$surgeries->getSurgery_name()}', this.surgery_date='{$surgeries->getSurgery_date()}', this.notes='{$surgeries->getNotes()}', this.timee='{$surgeries->getTimee()}', this.time='{$surgeries->getTime()}'");}}
