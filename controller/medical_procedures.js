class Medical_procedures{
  ...
  async add(){ try{ eval(await this.request('controller/medical_procedures.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&procedure_date=' + this.procedure_date + '&procedure_type=' + this.procedure_type + '&procedure_notes=' + this.procedure_notes + '&time=' + this.time + '&add=1')); }catch(err){}}
  async update(){ try{ eval(await this.request('controller/medical_procedures.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&procedure_date=' + this.procedure_date + '&procedure_type=' + this.procedure_type + '&procedure_notes=' + this.procedure_notes + '&time=' + this.time + '&update=1')); }catch(err){}}
