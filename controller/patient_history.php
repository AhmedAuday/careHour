<?php
  ...
  if(!empty($_GET['getLastRow'])){if($patient_history->getLastRow()){exit("this.id='{$patient_history->getId()}', this.files_id='{$patient_history->getFiles_id()}', this.diagnosis='{$patient_history->getDiagnosis()}', this.treatment='{$patient_history->getTreatment()}', this.notes='{$patient_history->getNotes()}', this.created_at='{$patient_history->getCreated_at()}', this.updated_at='{$patient_history->getUpdated_at()}', this.time='{$patient_history->getTime()}'");}}
