class Patient_files{
  ...
  async add(){ try{ eval(await this.request('controller/patient_files.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&file_name=' + this.file_name + '&file_type=' + this.file_type + '&created_at=' + this.created_at + '&timee=' + this.timee + '&time=' + this.time + '&add=1')); }catch(err){}}
  async update(){ try{ eval(await this.request('controller/patient_files.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&file_name=' + this.file_name + '&file_type=' + this.file_type + '&created_at=' + this.created_at + '&timee=' + this.timee + '&time=' + this.time + '&update=1')); }catch(err){}}
  ...
  async getByTimee(){ try{ eval(await this.request('controller/patient_files.php?getByTimee=' + this.timee)); }catch(err){}}
  async getByTime(){ try{ eval(await this.request('controller/patient_files.php?getByTime=' + this.time)); }catch(err){}}
  // GET THE RESULT AS JSON
  async getBySet(value = 100000){ try{ return await this.request('controller/patient_files.php?id=' + this.id + '&patient_id=' + this.patient_id + '&doctor_id=' + this.doctor_id + '&file_name=' + this.file_name + '&file_type=' + this.file_type + '&created_at=' + this.created_at + '&timee=' + this.timee + '&time=' + this.time + '&getBySet=' + value); }catch(err){}}
