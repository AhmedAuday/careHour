<?php
  ...
  if(!empty($_GET['timee'])){$medical_procedures->setTimee($_GET['timee']);}
  ...
  if(!empty($_GET['getByTimee'])){$medical_procedures->setTimee($_GET['getByTimee']); if($medical_procedures->getByTimee()){exit("this.id='{$medical_procedures->getId()}', this.patient_id='{$medical_procedures->getPatient_id()}', this.doctor_id='{$medical_procedures->getDoctor_id()}', this.procedure_date='{$medical_procedures->getProcedure_date()}', this.procedure_type='{$medical_procedures->getProcedure_type()}', this.procedure_notes='{$medical_procedures->getProcedure_notes()}', this.timee='{$medical_procedures->getTimee()}', this.time='{$medical_procedures->getTime()}'");}}
